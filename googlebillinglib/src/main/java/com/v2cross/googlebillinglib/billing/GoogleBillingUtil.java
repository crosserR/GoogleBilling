...
public class GoogleBillingUtil {
    ...
    public static final String BILLING_TYPE_INAPP = "inapp";//内购
    public static final String BILLING_TYPE_SUBS = "subs";//订阅
     ...
     * Google查询商品信息回调接口
     */
    private static class MySkuDetailsResponseListener implements SkuDetailsResponseListener {
     ...
     * Googlg消耗商品回调
     */
    private static class MyConsumeResponseListener implements ConsumeResponseListener {
        private String tag;
     ...
     * Googlg消耗商品回调
     */
    private static class MyAcknowledgePurchaseResponseListener implements AcknowledgePurchaseResponseListener {
    ...
    private static class MyPurchaseHistoryResponseListener implements PurchaseHistoryResponseListener {
